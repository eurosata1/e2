...
class InfoBarChannelSelection:
	...
	def keyUpCheck(self):
		if config.usage.oldstyle_zap_controls.value == "neutrino" or config.usage.oldstyle_zap_controls.value == "eurosat":
			self.zapDown()
		else:
	...
	def keyLeftCheck(self):
		if config.usage.oldstyle_zap_controls.value == "neutrino":
			self.switchChannelUp()
		elif config.usage.oldstyle_zap_controls.value == "eurosat":
